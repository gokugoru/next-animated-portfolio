      ...
      <motion.div className='h-full' initial={{ y: '-200vh'}} animate={{y: '0%'}} transition={{ duration: 1}}>
          <div className='h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
              ...
              <div className='h-1/2 flex flex-col lg:h-full lg:w-1/2 gap-8 items-center justify-center'>
                  ...
                  {/*Desc*/}
                  <p className=''>Welcome to my digital canvas, where innovation and creativity converge. With a keen eye for aesthetics and a mastery of code, my portfolio showcases a diverse collection of projects that reflect my commitments to excellence.</p>
                  {/*Buttons*/}
